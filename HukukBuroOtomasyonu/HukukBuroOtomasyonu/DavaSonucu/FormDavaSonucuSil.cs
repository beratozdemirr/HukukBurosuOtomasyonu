...
{
    public partial class FormDavaSonucuSil : Form
    {
        public FormDavaSonucuSil()
        {
            InitializeComponent();
        }
        ...
        private void FormDavaSonucuSil_Load(object sender, EventArgs e)
        {
            MuvekilleriGetir();
            KayitGetir();
        }
        ...
        {
            if (baglanti.State == ConnectionState.Closed) baglanti.Open();
            SqlCommand spDavaSonucuSil = new SqlCommand();
            spDavaSonucuSil.Connection = baglanti;
            spDavaSonucuSil.CommandType = CommandType.StoredProcedure;
            spDavaSonucuSil.CommandText = "spDavaSonucuSil";
            spDavaSonucuSil.Parameters.Add("@DavaSonuc_ID", dataGridViewDavaSonuclari.CurrentRow.Cells[0].Value.ToString());
            spDavaSonucuSil.ExecuteNonQuery();
            MessageBox.Show("Dava Sonuç Bilgileri Silindi");
            KayitGetir();
        }
