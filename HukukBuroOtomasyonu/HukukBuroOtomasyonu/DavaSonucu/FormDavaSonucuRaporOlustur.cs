...
{
    public partial class FormDavaSonucuRaporOlustur : Form
    {
        public FormDavaSonucuRaporOlustur()
        {
            InitializeComponent();
        }
        ...
        private void FormDavaSonucuRaporOlustur_Load(object sender, EventArgs e)
        {
            MuvekilleriGetir();
            KayitGetir();
        }
