...
{
    public partial class FormDavaGelismeleri : Form
    {
        public FormDavaGelismeleri()
        {
            InitializeComponent();
        }
        ...
        private void FormDavaGelismeleri_Load(object sender, EventArgs e)
        {
            MuvekilleriGetir();
            KayitGetir();
        }

        private void buttonDavaGelismesiEkle_Click(object sender, EventArgs e)
        {
            FormDavaGelismesiEkle gelismeEkle = new FormDavaGelismesiEkle();
            gelismeEkle.ShowDialog();
        }

        private void buttonDavaGelismesiSil_Click(object sender, EventArgs e)
        {
            FormDavaGelismesiSil gelismeSil = new FormDavaGelismesiSil();
            gelismeSil.ShowDialog();
        }

        private void buttonDavaGelismesiGuncelle_Click(object sender, EventArgs e)
        {
            FormDavaGelismesiGuncelle gelismeGuncelle = new FormDavaGelismesiGuncelle();
            gelismeGuncelle.ShowDialog();
        }

        private void buttonRaporOlustur_Click(object sender, EventArgs e)
        {
            FormDavaGelismesiRaporOlustur gelismeRapor = new FormDavaGelismesiRaporOlustur();
            gelismeRapor.ShowDialog();
        }
